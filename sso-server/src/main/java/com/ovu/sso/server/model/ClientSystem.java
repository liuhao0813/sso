package com.ovu.sso.server.model;
...
import com.ovu.sso.common.StringUtil;
...
public class ClientSystem implements Serializable {
	...
	private Logger logger = LoggerFactory.getLogger(ClientSystem.class);
    ...
    private String httpAccess(String theUrl) throws Exception {
        ...
        logger.debug("通知发送成功，通知URL为："+url.toString());
        conn.disconnect();
        is.close();
